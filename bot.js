...
${prefix}avatar | صورتك او صورة الي تمنشنو:bust_in_silhouette:
  ...
  ===============================================
   ...
   ${prefix}role all <rank> | لأعطاء رتبة للجميع:shield: 

   ${prefix}role humans <rank> | لأعطاء رتبة للاشخاص فقط :man: , :woman: 

  ${prefix}role bots <rank> | لأعطاء رتبة لجميع البوتات:robot: 

   ${prefix}schannel | اضهار الشات المخفية:blush: 

   ${prefix}hchannel | اخفاء الشات:arrow_heading_down: 

   ${prefix}clr <numbr> | مسح الشات بعدد:information_source: 

   ${prefix}clear | مسح الشات  :recycle: 
...
====================================================   
   ${prefix}rps | حجر ورقة مقص  :video_game:

   ${prefix}speed | اسرع كتابن  :video_game:

   ${prefix}quas | اسئلة عامة  :video_game:

   ${prefix}نكت | نكت  :video_game:

   ${prefix}لعبة فكك | فكك  :video_game:

   ${prefix}لعبة عواصم | عواصم :video_game:

   ${prefix}لعبة كت تويت | كت تويت  :video_game:

   ${prefix}roll | قرعة راندوم :video_game:

   ${prefix}لو خيروك بطريقة حلوة | لوخيروك

   ${prefix}لعبة مريم | مريم :video_game: 

   ${prefix}فوائد نصائح | هلتعلم  :video_game: 

   ${prefix}يعطيك عقابات قاسية |عقاب** :video_game:
==================================================   
 :musical_note:  اوامر الميوزك :musical_note: 
==================================================   
...
if (message.author.id !== '522810967738941440') return message.reply('** هذا الأمر فقط لصاحب البوت و شكراًً **')
...
if (!profile[getvalueof.id]) profile[getvalueof.id] = {points: 0,reps: "NOT YET",credits: 1, level: 1,tite: "HypeLC User", rep: 0, lastDaily: "NOT COLLECTED"};
            ...
            fs.readFile("p.png", function (err, Background) { //امتداد الصورة
...
const sWlc = {}
const premium = ['522810967738941440', '', '', '']
client.on('message', message => {
